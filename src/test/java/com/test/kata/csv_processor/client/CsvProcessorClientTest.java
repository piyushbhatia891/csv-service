...
import com.test.kata.csv_processor.BaseTest;
...
public class CsvProcessorClientTest extends BaseTest {
	...
	@Test(expected = CsvProcessorException.class)
	public void sortCsvFileContentByAgeForInvalidFile() throws FileNotFoundException {
		csvClientFileRequest.setFileUrl("");
		csvClientFileRequest.setColumnNames(csvFileObjects);
		client.sortCsvFileContent(csvFileLoadStrategy, csvClientFileRequest);
	}
}
